...
int[] arr3 ={};		// 기본 int, double 형 등 일반 타입은 null을 받지 못해서 여기 사용 못한다. 
...
<hr />
\${! empty array1 } : ${not empty array1 } <br />
\${! empty array2 } : ${not empty array2 } <br />

<hr />
\${empty param.name } : ${empty param.name } <br />
\${not empty param.name } : ${not empty param.name } <br />
null인지 확인//
http://localhost/myjsp/chap11/elEx12OperatorEmpty.jsp?name=john 이면 false
